...
export default function WoodWindowsPage() {
  const content = {
    ...
    subtitle: 'Period-Correct Wood Windows for Dallas Tudors, Craftsman Bungalows, and Spanish Colonials',
    ...
    sections: [
      {
        heading: 'Where Wood Windows Belong in Dallas',
        content:
      ...
      {
        heading: 'Wood Species and Durability Choices',
        content:
      ...
      {
        heading: 'Energy Performance of Modern Wood Windows',
        content:
      ...
      {
        heading: 'Architectural Detail That Synthetic Materials Cannot Match',
        content:
      ...
      {
        heading: 'Storm Windows, Storm Glazing, and Hail Protection',
        content:
      ...
      {
        heading: 'Investment, Value, and Long-Term Ownership',
        content:
    ...
    brands: [
      ...
      {
        name: 'Pella Reserve and Architect Series',
        description:
    ...
    faq: [
      {
        question: 'Are wood windows required in any Dallas neighborhoods?',
        answer:
      ...
      {
        question: 'How often do wood windows need maintenance in the Dallas climate?',
        answer:
      ...
      {
        question: 'What wood species are best for Dallas heat and humidity?',
        answer:
      ...
      {
        question: 'Should I restore my original wood windows or replace them?',
        answer:
      ...
      {
        question: 'Can wood windows handle Dallas hailstorms?',
        answer:
      ...
      {
        question: 'How much do wood windows cost installed in Dallas?',
        answer:
