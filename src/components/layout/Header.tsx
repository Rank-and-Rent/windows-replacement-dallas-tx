...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div className={`fixed top-0 right-0 h-full w-full max-w-[320px] bg-white shadow-xl z-50 transform transition-transform duration-300 lg:hidden ${isMobileMenuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
        <div className="p-6">
